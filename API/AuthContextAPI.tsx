...
// export const API_ADDRESS = "http://192.168.0.104:8080"; // nhớ thay đổi địa chỉ
...
// Constants
const TOKEN_KEY = "my_jwt";
export const API_ADDRESS = "http://192.168.0.104:8080"; // Đổi bằng biến môi trường nếu cần
export const API_URL = `${API_ADDRESS}/api/v1`;
